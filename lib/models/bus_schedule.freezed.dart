...
/// @nodoc
abstract class _$$_BusScheduleCopyWith<$Res>
    implements $BusScheduleCopyWith<$Res> {
  factory _$$_BusScheduleCopyWith(
          _$_BusSchedule value, $Res Function(_$_BusSchedule) then) =
      __$$_BusScheduleCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? scheduleId,
...
/// @nodoc
class __$$_BusScheduleCopyWithImpl<$Res>
    extends _$BusScheduleCopyWithImpl<$Res, _$_BusSchedule>
    implements _$$_BusScheduleCopyWith<$Res> {
  __$$_BusScheduleCopyWithImpl(
      _$_BusSchedule _value, $Res Function(_$_BusSchedule) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_BusSchedule implements _BusSchedule {
  _$_BusSchedule(
      {this.scheduleId,
      required this.bus,
  ...
  factory _$_BusSchedule.fromJson(Map<String, dynamic> json) =>
      _$$_BusScheduleFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_BusScheduleCopyWith<_$_BusSchedule> get copyWith =>
      __$$_BusScheduleCopyWithImpl<_$_BusSchedule>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_BusScheduleToJson(
      this,
    );
  }
}
...
abstract class _BusSchedule implements BusSchedule {
  factory _BusSchedule(
      ...
      int discount,
      int processingFee}) = _$_BusSchedule;

  factory _BusSchedule.fromJson(Map<String, dynamic> json) =
      _$_BusSchedule.fromJson;
