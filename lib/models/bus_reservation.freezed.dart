...
/// @nodoc
abstract class _$$_BusReservationCopyWith<$Res>
    implements $BusReservationCopyWith<$Res> {
  factory _$$_BusReservationCopyWith(
          _$_BusReservation value, $Res Function(_$_BusReservation) then) =
      __$$_BusReservationCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? reservationId,
...
/// @nodoc
class __$$_BusReservationCopyWithImpl<$Res>
    extends _$BusReservationCopyWithImpl<$Res, _$_BusReservation>
    implements _$$_BusReservationCopyWith<$Res> {
  __$$_BusReservationCopyWithImpl(
      _$_BusReservation _value, $Res Function(_$_BusReservation) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_BusReservation(
      reservationId: freezed == reservationId
          ? _value.reservationId
          : reservationId // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_BusReservation implements _BusReservation {
  _$_BusReservation(
      {this.reservationId,
  ...
  factory _$_BusReservation.fromJson(Map<String, dynamic> json) =>
      _$$_BusReservationFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_BusReservationCopyWith<_$_BusReservation> get copyWith =>
      __$$_BusReservationCopyWithImpl<_$_BusReservation>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_BusReservationToJson(
      this,
    );
  }
}
...
abstract class _BusReservation implements BusReservation {
  factory _BusReservation(
      ...
      required int totalPrice}) = _$_BusReservation;

  factory _BusReservation.fromJson(Map<String, dynamic> json) =
      _$_BusReservation.fromJson;
